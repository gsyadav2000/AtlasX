"""
EpiMatch Format Adapters

Tries EpiMatch's existing loaders against a downloaded file, without
...
tries the loaders EpiMatch already has, in order, and reports failure
...
def try_load_dataset(filepath):
    """
    Attempts to load filepath with each known EpiMatch loader, based on
