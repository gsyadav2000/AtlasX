"""
EpiMatch Command Line Interface
"""

import argparse

from epimatch import __version__
...
def dataset_summary(args):
    ...
    print()
    print("=" * 50)
    print("EpiMatch Dataset Summary")
    print("=" * 50)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="epimatch",
        description="EpiMatch : Single-cell ATAC Analysis Toolkit"
    )
